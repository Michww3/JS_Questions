...
| 18  | [Расскажите о стрелочных функциях (Arrow Functions). В чем заключаются отличия стрелочных функций от обычных?](#расскажите-о-стрелочных-функциях-arrow-functions-в-чем-заключаются-отличия-стрелочных-функций-от-обычных) |
...
| 26  | [Что делает метод map()?](#что-делает-метод-map) |
| 27  | [Что делает метод filter()?](#что-делает-метод-filter) |
| 28  | [Что делает метод reduce()?](#что-делает-метод-reduce) |
...
| 43  | [Как в JavaScript создать объект?](#как-в-javascript-создать-объект) |
...
| 50  | [Чем отличается prototype от __proto__?](#чем-отличается-prototype-от-__proto__) |
...
| 57  | [Что такое чейнинг функций?](#что-такое-чейнинг-функций) |
